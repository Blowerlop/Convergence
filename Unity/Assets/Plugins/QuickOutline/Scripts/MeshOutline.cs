...
public class MeshOutline : MonoBehaviour
{
    ...
    {
        // Cache renderers
        // Quick fix to not show outlines on particles :/
    ...
    public void Show(float width, float duration)
    {
        DOTween.To(() => OutlineWidth, x => OutlineWidth = x, width, duration);
    }
    ...
    public void Hide(float duration)
    {
        ...
        DOTween.To(() => OutlineWidth, x => OutlineWidth = x, 0, duration);
    }
